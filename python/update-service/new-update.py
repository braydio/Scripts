#!/usr/bin/env python3
"""
Unified Arch/DietPi system updater with OpenAI log summarization.
...
def parse_args():
    p = argparse.ArgumentParser(
        prog="arch-update.py",
        description=(
            "Unified Arch/DietPi system updater.\n\n"
        ...
        epilog=textwrap.dedent(
            ...
            EXAMPLES:
              ...
              Run full update with auto-confirm and summary:
                arch-update.py
              ...
              Aggressively clean caches after update:
                arch-update.py --deep-clean --aggressive-cache
            """
        ),
    )
